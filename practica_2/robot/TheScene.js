...
class TheScene extends THREE.Scene {
  ...
  createModel() {
    ...
    this.robot = new Robot({
      eyeMaterial: new THREE.MeshPhongMaterial({ color: "#000000", specular: "#000000", shininess: 70 }),
      headMaterial: new THREE.MeshPhongMaterial({ color: "#888888", specular: "#888888", shininess: 70 }),
      bodyMaterial: new THREE.MeshPhongMaterial({ color: "#e8e8e8", specular: "#e8e8e8", shininess: 70 }),
      footMaterial: new THREE.MeshPhongMaterial({ color: "#001284", specular: "#001284", shininess: 70 }),
      legMaterial: new THREE.MeshPhongMaterial({ color: "#e8e8e8", specular: "#e8e8e8", shininess: 70 }),
      shoulderMaterial: new THREE.MeshPhongMaterial({ color: "#001284", specular: "#001284", shininess: 70 })
    })
